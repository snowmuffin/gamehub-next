                    ...
                    <div className="container">
                        <div className="my-auto">
                            <div className="row align-items-center justify-content-center h-100 text-center">
                                <Col xl={5}>
                                    <p className="error-text mb-4 text-primary">4<i className="ri-emotion-sad-line"></i>4</p>
                                    <p className="fs-3 fw-normal mb-3 text-fixed-white">Oops! Page Not Found.</p>
                                    <p className="fs-15 text-fixed-white mb-5 op-8">The page you are attempting to access may have been removed or is temporarily unavailable.</p>
