              ...
              <ol className="fs-14">
                <li className="mb-4">
                  ...
                  <p className="mb-0 text-muted">
                    업그레이드 모듈을 적용하여 그리드의 성능을 자유롭게 개조하고, 창의적인 설계를
                    실현할 수 있습니다.
                  </p>
                </li>
                <li className="mb-4">
                  ...
                  <p className="mb-0 text-muted">
                    웹페이지에서 별도의 인벤토리를 통해 인게임 아이템을 업로드/다운로드할 수 있어,
                    아이템 관리가 매우 편리합니다.
                  </p>
                </li>
                <li className="mb-4">
                  ...
                  <p className="mb-0 text-muted">
                    웹사이트 기반의 거래 시스템(곧 오픈 예정)으로 안전하고 간편하게 아이템을 교환할
                    수 있습니다.
                  </p>
                </li>
                <li className="mb-4">
                  ...
                  <p className="mb-0 text-muted">
                    웹사이트에서 실시간으로 집계되는 랭킹을 통해 다른 유저들과 경쟁하고 자신의
                    성과를 확인할 수 있습니다.
                  </p>
                </li>
                <li className="mb-4">
