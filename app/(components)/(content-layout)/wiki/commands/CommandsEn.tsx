                        ...
                        <div className="server-commands border p-3 overflow-scroll">
                            ...
                            <ol className="fs-14">
                                <li className="mb-3">
                                    ...
                                    <div className="text-muted">Uploads an item from your character's inventory to your web inventory.</div>
                                </li>
                                <li className="mb-3">
                                    <span className="fw-medium text-primary">!cmd listitems</span>
                                    <div className="text-muted">Displays a list of items in your character's inventory (shows names usable for upload).</div>
                                </li>
                                <li className="mb-3">
                            ...
                            <ol className="fs-14">
                                ...
                                <li>
                                    ...
                                    <div className="text-muted">
                                        Transfers grid ownership to a specific player. If you omit the grid name, ownership of the grid you are looking at will be transferred.
                                    </div>
                                </li>
                            </ol>
                        </div>
