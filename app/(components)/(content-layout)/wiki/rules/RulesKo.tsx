              ...
              <ol className="fs-14">
                <li className="mb-4">
                  ...
                  <p className="mb-0 text-muted">
                    치트, 핵, 버그 악용은 허용되지 않습니다. 버그나 악용 사례는 운영진에게
                    신고해주세요.
                  </p>
                </li>
                <li className="mb-4">
                ...
                <li className="mb-4">
                  ...
                  <p className="mb-0 text-muted">
                    NPC 그리드의 이름 변경 없이 재활용하거나 소유권을 얻지 않은 상태에서 사용할 경우
                    문제가 발생할 수 있습니다.
                  </p>
                </li>
                <li className="mb-4">
                  ...
                  <p className="mb-0 text-muted">
                    팩션, 블록, 그리드, 유저명 등에 영어가 아닌 문자를 사용할 경우 문제가 생길 수
                    있으므로, 가급적 영어 알파벳을 사용해 주세요.
                  </p>
                </li>
                <li className="mb-4">
                  <p className="fw-medium mb-2 fs-14 text-primary">PVP 규칙</p>
                  <p className="mb-0 text-muted">
                    PVP 제한은 따로 없으며, 자유롭게 전투를 즐길 수 있습니다.
                  </p>
                </li>
                <li className="mb-4">
                  <p className="fw-medium mb-2 fs-14 text-primary">건설 제한</p>
                  <p className="mb-0 text-muted">
                    대규모 구조물이나 스크립트 남용으로 서버 환경에 영향을 미칠 경우 제한될 수
                    있습니다.
                  </p>
                </li>
                <li>
                  ...
                  <p className="mb-0 text-muted">
                    오류로 인한 그리드 삭제로 복구를 원하시는 경우 Grid-Restore 채널로 문의해주시길
                    바랍니다. DM은 이제 받지 않겠습니다.
                    <ul className="mt-2">
                      <li>
                        <strong>6-1.</strong> 그리드 이름이 기본 이름 그대로인 경우는 복구해드리지
                        않습니다.
                      </li>
                      <li>
                        <strong>6-2.</strong> 버그로 보이더라도 물리적 파손으로 인한 경우에는 복구
                        대상이 아닙니다.
                      </li>
                    </ul>
                  </p>
