                ...
                <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            ...
                            <p className="card-text">Angela McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage</p>
                            <Link href="#!" scroll={false} className="btn btn-primary">Read More</Link>
                        </Card.Body>
                    </Card>
                    <Card className="custom-card">
            ...
            <Row>
                    ...
                    <Card className="custom-card">
                            ...
                            <div className="d-flex align-items-center w-100">
                                ...
                                <Dropdown className="ms-auto">
                                    ...
                                    <Dropdown.Menu as="ul">
                                        ...
                                        <Dropdown.Item as="li"><Link className="" href="#!" scroll={false}>Month</Link></Dropdown.Item>
                        ...
                        <Card.Footer>
                            <div className="d-flex justify-content-between">
                                <div className="fs-semibold fs-14">28,Nov 2023</div>
                ...
                <Col xl={4}>
                    <Card className="custom-card">
                        ...
                        <div className="bottom-left"></div>
                        <div className="bottom-right"></div>
                        <Card.Header className="justify-content-between border-bottom-0 pb-3">
                ...
                <Col xl={3}>
                    <Row>
                        ...
                        <div className="col-xl-12">
                            <div className="card border border-success mb-3 custom-card">
                                <Card.Header className="bg-transparent border-bottom border-success pb-2">Header</Card.Header>
                                <Card.Body className="text-success">
                                    <h6 className="card-title fw-medium text-success">Looking For Success?</h6>
                                    <p className="card-text">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.</p>
                                </Card.Body>
                        ...
                        <div className="col">
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    ...
                                    <Link href="#!" scroll={false} className="btn btn-primary">Purchase</Link>
                                </Card.Body>
                            </Card>
                        </div>
                        <div className="col">
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    ...
                                    <p className="card-text">With supporting text below as a natural
                                        lead-in to additional content.</p>
                                    <Link href="#!" scroll={false} className="btn btn-secondary">Purchase</Link>
                                </Card.Body>
                            </Card>
                        </div>
                        <div className="col">
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    ...
                                    <p className="card-text">With supporting text below as a natural
                                        lead-in to additional content.</p>
                                    <Link href="#!" scroll={false} className="btn btn-light">Purchase</Link>
                                </Card.Body>
                            </Card>
                        </div>
                    </div>
                    ...
                    <Card className="custom-card overlay-card">
                        ...
                        <div className="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                            <Card.Body className="text-fixed-white">
                                ...
                                <div className="card-text mb-2 d-none d-md-block">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</div>
                                <div className="card-text">Last updated 3 mins ago</div>
                            </Card.Body>
                ...
                <Col xl={4}>
                    <Card className="custom-card overlay-card">
                        ...
                        <div className="card-img-overlay d-flex flex-column p-0">
                            ...
                            <Card.Body className="text-fixed-white overflow-auto">
                    ...
                    <Card className="custom-card card-bg-light">
                        ...
                        <Card.Body>
                            <div className="d-flex align-items-center w-100">
                                ...
                                <div className="ms-auto">
                                    <Link href="#!" scroll={false} className="text-default"><i className="bi bi-three-dots-vertical"></i></Link>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card className="custom-card card-bg-dark">
                        ...
                        <Card.Body>
                            <div className="d-flex align-items-center w-100">
                                ...
                                <div className="ms-auto">
                                    <Link href="#!" scroll={false} className="text-white"><i className="bi bi-three-dots-vertical"></i></Link>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
            ...
            <Row>
                            ...
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p className="card-text mb-0 fs-14 fw-medium">Atharva Ayyan.</p>
                ...
                <Col xxl={3} xl={12} className="">
                    <Card className="custom-card">
                        ...
                        <div className="bottom-right"></div>
                        <Link href="#!" scroll={false} className="card-anchor"></Link>
                        <img src="../../assets/images/media/media-21.jpg" className="card-img-top" alt="..." />
                        <Card.Body>
