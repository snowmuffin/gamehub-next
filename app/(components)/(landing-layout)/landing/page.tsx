          ...
          <div className="header-content-right">
            <div className="header-element align-items-center">
              <div className="btn-list d-lg-none d-block">
                ...
                <Button
                  variant=""
                  className="btn btn-wave btn-icon btn-success switcher-icon"
      ...
      <div className="main-content landing-main px-0" onClick={handleClick}>
        ...
        <section className="section" id="glance">
          <div className="container position-relative">
            <div className="text-center">
              <p className="fs-12 fw-medium text-success mb-1">
                <span className="landing-section-heading">-Glance-</span>
              </p>
              <h3 className="fw-medium mb-2">Why you choose us</h3>
              <div className="row justify-content-center">
                <Col xl={7}>
                  <p className="text-muted fs-15 mb-5 fw-normal">
                    Our mission is to support you in achieving your goals.
                  </p>
                </Col>
              </div>
            </div>
            ...
            <div className="row gx-5 mx-0">
              ...
              <div className="col-xl-8 my-auto">
                <div className="heading-section text-start mb-4">
                  <div className="heading-subtitle fw-medium">
                    <span className="landing-section-heading text-success">-About Us-</span>
                  </div>
        ...
        <section className="section" id="services">
          <div className="container">
            <div className="text-center">
              <p className="fs-12 fw-medium text-success mb-1">
                <span className="landing-section-heading">-SERVICES-</span>
              </p>
              <h3 className="fw-medium mb-2">Our Best Services</h3>
              <div className="row justify-content-center">
                <Col xl={7}>
                  <p className="text-muted fs-15 mb-5 fw-normal">
                    Sed semper euismod, augue justo ullamcorper orci, eu imperdiet{" "}
                  </p>
                </Col>
              </div>
            </div>
                ...
                <div className="col-xl-3" key={Math.random()}>
                  <Card className="custom-card landing-card">
                    ...
                    <Card.Body>
                      <div className="mb-3">
                        <span
                          className={`avatar avatar-lg bg-${idx.color}-transparent border border-${idx.color} border-opacity-10`}
                        >
                      ...
                      <p className="fs-14 text-muted mb-0">
                        Justo aliquyam duo vero clita aliquyam vero eirmod stet amet dolorem ipsum.
                      </p>
                    </Card.Body>
                  </Card>
                </div>
            ...
            <Row>
                  ...
                  <Card.Body>
                    <div className="mb-4">
                      ...
                      <p className="text-justify fw-medium mb-1">
                        ...
                        <span className="fs-20 op-6">
                          <span className="fs-20">/</span> month
                        </span>
                      </p>
                    ...
                    <ul className="text-justify list-unstyled pricing-body ps-0">
                      <li className="mb-3">
                        <span className="me-1">
                          <i className="fe fe-check-circle align-middle fs-14 text-success d-inline-block"></i>
                        </span>{" "}
                        6 Users
                      </li>
                      <li className="mb-3">
                      ...
                      <li className="mb-3">
                        <span className="me-1">
                          <i className="fe fe-x-circle align-middle fs-16 op-5 d-inline-block"></i>
                        </span>{" "}
                        Advanced Security
                      </li>
                      <li className="mb-0">
              ...
              <Col xxl={3} lg={6} md={12} sm={12} className="col-12">
                <div className="card pricing-card border custom-card landing-card border-primary shadow-none">
                  <Card.Body>
                    <span className="popular-pricing-badge">
                      <i className="ri-flashlight-line me-1 d-inline-block"></i>Most Popluar
                    </span>
                    <div className="mb-4">
                    ...
                    <Card.Body>
                      ...
                      <div className="op-9 fs-14 mb-3">
                        ...
                        <Link
                          href="#!"
                          scroll={false}
                          className="fw-medium fs-11 text-info"
                          data-bs-toggle="tooltip"
                          data-bs-custom-classname="tooltip-primary"
                          data-bs-placement="top"
                          data-bs-title="Nulla maximus nunc ut euismod condimentum. Nunc vel quam maximus, sagittis ante non, tempor risus. Suspendissei. Nam lacus risus."
                        >
                          Read More
                        </Link>
                      </div>
                    ...
                    <Card.Body>
                      ...
                      <div className="op-9 fs-14 mb-3">
                        ...
                        <Link
                          ...
                          data-bs-custom-classname="tooltip-primary"
                          data-bs-placement="top"
                          data-bs-title="Mauris quis dolor ut nisl mattis dignissim sed ac massa. Nunc ante nisi, malesuada id leo sit amet, pretium fringilla dolor."
                        >
                          Read More
                        </Link>
                      </div>
        ...
        <section className="section" id="faqs">
          <div className="container text-center">
            ...
            <div className="row justify-content-center">
              <Col xl={7}>
                <p className="text-muted fs-15 mb-5 fw-normal">
                  We have provided a list of commonly asked questions to assist you..
                </p>
              </Col>
            </div>
        ...
        <section className="section section-bg" id="team">
          <div className="container">
            <div className="text-center">
              <p className="fs-12 fw-medium text-success mb-1">
                <span className="landing-section-heading">-TEAM-</span>
              </p>
              <h3 className="fw-medium mb-2">Meet our amazing Team</h3>
              <div className="row justify-content-center">
                <Col xl={7}>
                  <p className="text-muted fs-15 mb-5 fw-normal">
                    Our team is made up of real people who are passionate about what they do.
                  </p>
                </Col>
              </div>
            </div>
                ...
                <Col xl={3} lg={3} md={6} sm={6} className="col-12 mb-lg-0 mb-4" key={Math.random()}>
                  <Card className="custom-card  team-card text-center">
                    ...
                    <Card.Body>
                      <img
                        src={idx.src1}
                        className="avatar avatar-xxl mb-4 mb-3 border p-1 bg-primary-transparent landing-team-img mt-2"
                        alt="..."
                      />
                      <div className="text-center py-2">
                        ...
                        <div className="d-flex justify-content-center mt-4">
                          ...
                          >
                            <i className="ri-twitter-x-line align-middle"></i>
                          </Link>
                          <Link
                            aria-label="anchor"
                            href="#!"
                            scroll={false}
                            className="btn btn-sm btn-icon btn-primary-light btn-wave waves-effect waves-light ms-2"
                          >
                            <i className="ri-facebook-line align-middle"></i>
                          </Link>
                          <Link
                            aria-label="anchor"
                            href="#!"
                            ...
                            className="btn btn-sm btn-icon btn-primary-light btn-wave waves-effect waves-light ms-2"
                          >
                            <i className="ri-instagram-line align-middle"></i>
                          </Link>
                          <Link
                            aria-label="anchor"
                            href="#!"
                            ...
                            className="btn btn-sm btn-icon btn-primary-light btn-wave waves-effect waves-light ms-2"
                          >
                            <i className="ri-linkedin-line align-middle"></i>
                          </Link>
                        </div>
                      </div>
                    </Card.Body>
                      ...
                      <div className="row mt-2 px-3">
                        <Col xl={12}>
                          <div className="row gy-3">
                            <Col xl={12}>
                              <Form.Label htmlFor="contact-address-name" className="form-label ">
                                Full Name :
                              </Form.Label>
                              <Form.Control
                                type="text"
                            ...
                            <Col xl={12}>
                              <Form.Label htmlFor="contact-address-mail" className="form-label ">
                                Mail Address :
                              </Form.Label>
                              <Form.Control
                                type="text"
                                className="form-control "
                                id="contact-address-mail"
                        ...
                        <Col xl={12}>
                          <Form.Label htmlFor="contact-address-message" className="form-label ">
                            Message :
                          </Form.Label>
                          <Form.Control
                            as="textarea"
                        ...
                        <Col xl={12}>
                          <div className="text-end mt-4">
                            <Button variant="" className="btn btn-primary btn-wave">
                              Send Message
                            </Button>
                          </div>
                        </Col>
                  ...
                  <Col xxl={6} xl={6} lg={6} md={12} sm={12} className="">
                    <div className="p-4 landing-contact-info">
                      <div className="p-3">
                        ...
                        <div className="mb-4">
                          <i className="ri-mail-fill me-2 d-inline-block text-primary"></i>{" "}
                          carolinahanasandy4424@example.com
                        </div>
                      </div>
            ...
            <Row>
              ...
              <Col md={2} sm={6} className="col-12">
                <div className="px-4">
                  ...
                  <ul className="list-unstyled op-6 fw-normal landing-footer-list fs-14 mb-0">
                    <li>
                      <Link href="#!" scroll={false} className="text-fixed-white">
                        Profile
                      </Link>
                    </li>
                    <li>
              ...
              <Col md={3} sm={6} className="col-12">
                <div className="px-4">
                  ...
                  <ul className="list-unstyled fw-normal mb-0 landing-footer-list fs-14">
                    <li>
                      <Link href="#!" scroll={false} className="text-fixed-white op-6">
                        <i className="ri-home-4-line me-1 align-middle"></i> New York, NY 10012, US
                      </Link>
                    </li>
                    <li>
                      <Link href="#!" scroll={false} className="text-fixed-white op-6">
                        <i className="ri-mail-line me-1 align-middle"></i> info@fmail.com
                      </Link>
                    </li>
                    <li>
                      <Link href="#!" scroll={false} className="text-fixed-white op-6">
                        <i className="ri-mail-line me-1 align-middle"></i> contact@fmail.com
                      </Link>
                    </li>
                    <li>
                      <Link href="#!" scroll={false} className="text-fixed-white op-6">
                        <i className="ri-phone-line me-1 align-middle"></i> +(555)-1920 1831
                      </Link>
                    </li>
                    <li>
                      <Link href="#!" scroll={false} className="text-fixed-white op-6">
                        <i className="ri-printer-line me-1 align-middle"></i> +(123) 1293 123
                      </Link>
                    </li>
                  </ul>
                </div>
        ...
        <div className="text-center landing-main-footer py-3">
          <span className="text-muted fs-15">
            ...
            <Link href="#!" scroll={false} className="text-primary fw-medium">
              <u>SciFi</u>
            </Link>
            . Designed with <span className="ri-heart-fill text-danger"></span> by{" "}
            <Link href="#!" scroll={false} className="text-primary fw-medium">
              <u>Spruko</u>
            </Link>{" "}
            All rights reserved
