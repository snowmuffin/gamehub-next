  ...
  apps: [
    {
      ...
      env: {
        ...
        NEXT_PUBLIC_STEAM_AUTH_URL: process.env.NEXT_PUBLIC_STEAM_AUTH_URL || "https://api.domain.com/auth/steam",
        NEXT_PUBLIC_ALLOWED_ORIGINS: process.env.NEXT_PUBLIC_ALLOWED_ORIGINS || "http://domain.com,https://domain.com"
      },
      env_production: {
        NODE_ENV: "production",
        PORT: process.env.PORT || 3000,
