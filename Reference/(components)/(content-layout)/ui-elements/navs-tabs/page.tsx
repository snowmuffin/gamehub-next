                            ...
                            <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                                <Nav variant='tabs' className="nav nav-tabs mb-3 border-0" role="tablist">
                                    ...
                                    <Dropdown className="nav-item dropdown">
                                        ...
                                        <Dropdown.Menu as="ul">
                                            <Dropdown.Item as="li" href="#homeabout-dropdown" eventKey="second"
                            ...
                            <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                                <Nav variant='pills' className="nav nav-pills mb-3" role="tablist" defaultActiveKey="first">
                                    ...
                                    <Dropdown className="nav-item dropdown" >
                                        ...
                                        <Dropdown.Menu as="ul">
                                            <Dropdown.Item as="li"href="#!" eventKey="second"
                                            >Wishlist</Dropdown.Item>
                                            <Dropdown.Item as="li">Liked</Dropdown.Item>
                                            <Dropdown.Item as="li">Save For Later</Dropdown.Item>
                                            <li>
                                                <hr className="dropdown-divider" />
                                            </li>
                                            <Dropdown.Item as="li">Recently Viewed</Dropdown.Item>
                                        </Dropdown.Menu>
                                    </Dropdown>
                                    <Nav.Item>
            ...
            <Row>
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                                <Nav variant='pills' className=" nav-pills flex-column flex-sm-row mb-3" role="tablist" defaultActiveKey="first">
