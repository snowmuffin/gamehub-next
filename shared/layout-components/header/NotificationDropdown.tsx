...
const NotificationDropdown = () => {
  ...
  const img1 = <span className="avatar avatar-rounded"><img src="/assets/images/faces/6.jpg" /></span>;
  const img2 = <span className="avatar avatar-rounded"><img src="/assets/images/faces/23.jpg" /></span>;
  const img3 = <span className="avatar avatar-rounded"><img src="/assets/images/faces/11.jpg" /></span>;
            ...
            <Dropdown.Item as="li" className="dropdown-item" key={Math.random()}>
              <div className="d-flex align-items-center">
                ...
                <div className="flex-grow-1 d-flex align-items-center justify-content-between">
                  <div>
                    <p className="mb-0 fw-medium"><Link href="/pages/notifications">{idx.heading}</Link></p>
                    <span className="text-muted fw-normal fs-12 header-notification-text">{idx.data}</span>
                  </div>
                  <div>
                    <Link href="#!" onClick={(event) => handleNotificationClose(index, event)} className="min-w-fit-content text-muted me-1 dropdown-item-close1"><i className="bi bi-x fs-16"></i></Link>
                  </div>
                </div>
              </div>
            </Dropdown.Item>
