...
const Switcher = ({ local_variable, ThemeChanger }: any) => {
                                    ...
                                    <div className="row switcher-style gx-0 pb-2 gy-2">
                                        ...
                                        <div className="col-4">
                                            <div className="form-check switch-select">
                                                ...
                                                <input className="form-check-input" type="radio" name="navigation-menu-styles"
                                                    checked={local_variable.dataNavStyle == 'menu-hover'} onChange={(_e) => { }}
                                        ...
                                        <div className="col-4">
                                            <div className="form-check switch-select">
                                                ...
                                                <input className="form-check-input" type="radio" name="navigation-menu-styles"
                                                    checked={local_variable.dataNavStyle == 'icon-click'} onChange={(_e) => { }}
									...
									<div className="row switcher-style gx-0  gy-2">
										...
										<div className="col-sm-6">
											<div className="form-check switch-select">
												...
												<input className="form-check-input" type="radio" name="sidemenu-layout-styles"
													checked={local_variable.dataToggled == "close-menu-close"} onChange={(_e) => { }}
										...
										<div className="col-sm-6">
											<div className="form-check switch-select">
												...
												<input className="form-check-input" type="radio" name="sidemenu-layout-styles"
													checked={local_variable.dataToggled == "icon-text-close"} onChange={(_e) => { }}
										...
										<div className="col-sm-6">
											<div className="form-check switch-select">
												...
												<input className="form-check-input" type="radio" name="sidemenu-layout-styles"
													// checked={local_variable.dataToggled == "icon-overlay-close"} onChange={(_e) => { }}
										...
										<div className="col-sm-6">
											<div className="form-check switch-select">
												...
												<input className="form-check-input" type="radio" name="sidemenu-layout-styles"
													// checked={local_variable.dataToggled == "detached-close"} onChange={(_e) => { }}
										...
										<div className="col-sm-6">
											<div className="form-check switch-select">
												...
												<input className="form-check-input" type="radio" name="sidemenu-layout-styles"
													checked={local_variable.dataVerticalStyle == "doublemenu"} onChange={(_e) => { }}
                                    ...
                                    <div className="row switcher-style gx-0">
                                        <div className="col-4">
                                            <div className="form-check switch-select">
                                                ...
                                                <input className="form-check-input" type="radio" name="header-positions"
                                                    ...
                                                    checked={local_variable.dataHeaderPosition == 'fixed'} onChange={(_e) => { }}
                                        ...
                                        <div className="col-4">
                                            <div className="form-check switch-select">
                                                ...
                                                <input className="form-check-input" type="radio" name="header-positions"
                                                    checked={local_variable.dataHeaderPosition == 'scrollable'} onChange={(_e) => { }}
                                        ...
                                        <div className="d-flex flex-wrap align-items-center switcher-style">
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern1" type="radio"
                                                    name="background-pattern" id="switcher-pattern-img" checked={local_variable.patternImg == 'bgpattern1'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Pattern1(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern2" type="radio"
                                                    name="background-pattern" id="switcher-pattern-img1" checked={local_variable.patternImg == 'bgpattern2'} onChange={(_e) => { }}
                                            ...
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern3" type="radio" name="background-pattern"
                                                    id="switcher-pattern-img2" checked={local_variable.patternImg == 'bgpattern3'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Pattern3(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern4" type="radio"
                                                    name="background-pattern" id="switcher-pattern-img3" checked={local_variable.patternImg == 'bgpattern4'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Pattern4(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern5" type="radio"
                                                    name="background-pattern" id="switcher-pattern-img4" checked={local_variable.patternImg == 'bgpattern5'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Pattern5(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern6" type="radio"
                                                    name="background-pattern" id="switcher-pattern-img5" checked={local_variable.patternImg == 'bgpattern6'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Pattern6(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern7" type="radio"
                                                    name="background-pattern" id="switcher-pattern-img6" checked={local_variable.patternImg == 'bgpattern7'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Pattern7(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern8" type="radio"
                                                    name="background-pattern" id="switcher-pattern-img7" checked={local_variable.patternImg == 'bgpattern8'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Pattern8(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern9" type="radio"
                                                    name="background-pattern" id="switcher-pattern-img8" checked={local_variable.patternImg == 'bgpattern9'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Pattern9(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input patternimage-input bg-pattern10" type="radio"
                                                    name="background-pattern" id="switcher-pattern-img9" checked={local_variable.patternImg == 'bgpattern10'} onChange={(_e) => { }}
                                        ...
                                        <div className="d-flex flex-wrap align-items-center switcher-style">
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style1" type="radio"
                                                    name="card-style" id="switcher-card-style" checked={local_variable.dataCardStyle == 'style1'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Card1(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style2" type="radio"
                                                    name="card-style" id="switcher-card-style1" checked={local_variable.dataCardStyle == 'style2'} onChange={(_e) => { }}
                                            ...
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style3" type="radio" name="card-style"
                                                    id="switcher-card-style2" checked={local_variable.dataCardStyle == 'style3'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Card3(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style4" type="radio"
                                                    name="card-style" id="switcher-card-style3" checked={local_variable.dataCardStyle == 'style4'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Card4(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style5" type="radio"
                                                    name="card-style" id="switcher-card-style4" checked={local_variable.dataCardStyle == 'style5'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Card5(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style6" type="radio"
                                                    name="card-style" id="switcher-card-style5" checked={local_variable.dataCardStyle == 'style6'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Card6(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style7" type="radio"
                                                    name="card-style" id="switcher-card-style6" checked={local_variable.dataCardStyle == 'style7'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Card7(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style8" type="radio"
                                                    name="card-style" id="switcher-card-style7" checked={local_variable.dataCardStyle == 'style8'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Card8(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style9" type="radio"
                                                    name="card-style" id="switcher-card-style8" checked={local_variable.dataCardStyle == 'style9'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Card9(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-style10" type="radio"
                                                    name="card-style" id="switcher-card-style9" checked={local_variable.dataCardStyle == 'style10'} onChange={(_e) => { }}
                                        ...
                                        <div className="d-flex flex-wrap align-items-center switcher-style">
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-background1" type="radio"
                                                    name="card-background" id="switcher-card-background" checked={local_variable.dataCardBackground == 'background1'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Background1(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-background2" type="radio"
                                                    name="card-background" id="switcher-card-background1" checked={local_variable.dataCardBackground == 'background2'} onChange={(_e) => { }}
                                            ...
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-background3" type="radio" name="card-background"
                                                    id="switcher-card-background2" checked={local_variable.dataCardBackground == 'background3'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Background3(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-background4" type="radio"
                                                    name="card-background" id="switcher-card-background3" checked={local_variable.dataCardBackground == 'background4'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Background4(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-background5" type="radio"
                                                    name="card-background" id="switcher-card-background4" checked={local_variable.dataCardBackground == 'background5'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Background5(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-background6" type="radio"
                                                    name="card-background" id="switcher-card-background5" checked={local_variable.dataCardBackground == 'background6'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Background6(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-background7" type="radio"
                                                    name="card-background" id="switcher-card-background6" checked={local_variable.dataCardBackground == 'background7'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Background7(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-background8" type="radio"
                                                    name="card-background" id="switcher-card-background7" checked={local_variable.dataCardBackground == 'background8'} onChange={(_e) => { }}
                                                    onClick={() => { switcherdata.Background8(ThemeChanger); }} />
                                            </div>
                                            <div className="form-check switch-select m-2">
                                                <input className="form-check-input card-input card-background9" type="radio"
                                                    name="card-background" id="switcher-card-background8" checked={local_variable.dataCardBackground == 'background9'} onChange={(_e) => { }}
