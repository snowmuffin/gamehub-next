...
export const Linkalerts: alert2[] = [
  {
    text1: "A simple primary alert with ",
    text2: "an example link ",
    text3: "Give it a click if you like",
    class: "primary"
  },
  {
    text1: "A simple secondary alert with",
    text2: "an example link ",
    text3: "Give it a click if you like",
    class: "secondary"
  },
  {
    text1: "A simple success alert with",
    text2: "an example link ",
    text3: "Give it a click if you like",
    class: "success"
  },
  {
    text1: "A simple danger alert with ",
    text2: "an example link ",
    text3: "Give it a click if you like",
    class: "danger"
  },
  {
    text1: "A simple warning alert with ",
    text2: "an example link ",
    text3: "Give it a click if you like",
    class: "warning"
  },
...
export const Svgalert1: alert9[] = [
  ...
  },
  {
    ...
    class1: svg2,
    text1: "Success Alert",
    text2: "Success alert to show to success message",
    color: "secondary",
    btn1: "",
    btn2: "close",
    class: ""
  },
  {
    ...
    class1: svg3,
    text1: "Warning Alert",
    text2: "Warning alert to show warning message",
    color: "warning",
    btn1: "skip",
    btn2: "open",
    class: ""
  },
  {
    ...
    class1: svg4,
    text1: "Danger Alert",
    text2: "Danger alert to show the danger message",
    color: "danger",
    btn1: "close",
    btn2: "continue",
    class: ""
...
export const Svgalert: alert9[] = [
  ...
  {
    id: 3,
    class1: "M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z",
    text1: "Warning Alert",
    text2: "Warning alert to show warning message",
    color: "warning",
    btn1: "cancel",
