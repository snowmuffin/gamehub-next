...
export const BasicButtons: basicbtn[] = [
  { id: 1, src: "../../assets/images/faces/1.jpg", text: "Katelynn Julie" },
...
export const CustomButtons: custombtn[] = [
  {
    id: 1,
    heading: "Web page editors now use Lorem Ipsum?",
    text1: "3 days ago",
    class1: "active",
    text2:
  ...
  {
    id: 2,
    heading: "Richard McClintock, a Latin professor?",
    text1: "4 hrs ago",
    class1: "",
    text2:
  ...
  {
    id: 3,
    heading: "It uses a dictionary of over 200 Latin words?",
    text1: "15 hrs ago",
    class1: "",
  ...
  {
    id: 4,
    heading: "The standard Lorem Ipsum used since the 1500s?",
    text1: "45 mins ago",
    class1: "",
    text2:
...
export const SubheadingsButtons: subheading[] = [
  ...
  {
    id: 3,
    text1: "News Is A Great Weapon.",
    text2: "News can influence in many ways.",
    text3: "1,204 Views",
    class: "success-transparent"
  },
  {
    id: 4,
