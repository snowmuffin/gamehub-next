...
export const Languageoptions: Selectdata[] = [
...
export const Countryoptions: Selectdata[] = [
	{ value: "Usa", label: "Usa" },
	{ value: "Australia", label: "Australia" },
	{ value: "Dubai", label: "Dubai" },

];
export const Maximumoptions: Selectdata[] = [
	{ value: "10", label: "10" },
	{ value: "50", label: "50" },
	{ value: "100", label: "100" },
	{ value: "200", label: "200" },
...
export const MaxLimitoptions: Selectdata[] = [
...
export const Accountoptions: Selectdata[] = [
