...
function DetachedOpenFn() {
  if (window.innerWidth > 992) {
    const html = document.documentElement;
    if (
      html.getAttribute("data-dataToggled") === "detached-close" ||
      html.getAttribute("data-dataToggled") === "icon-overlay-close"
    ) {
...
//Background Patterns
export const Pattern1 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Pattern2 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Pattern3 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Pattern4 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Pattern5 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Pattern6 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Pattern7 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Pattern8 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Pattern9 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Pattern10 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
//Card Styleing
export const Card1 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Card2 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Card3 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Card4 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Card5 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Card6 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Card7 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Card8 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Card9 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Card10 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
//Card Background
export const Background1 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Background2 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Background3 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Background4 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Background5 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Background6 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Background7 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Background8 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const Background9 = (actionfunction: any) => {
  const theme = store.getState().local_variable;
  actionfunction({
    ...theme,
...
export const LocalStorageBackup = (actionfunction: any) => {
  ...
  //primitive
  if (localStorage.getItem("scifiltr") == null || localStorage.getItem("scifiltr") == "ltr") {
    // addOrRemoveCss(ltr);
  }
