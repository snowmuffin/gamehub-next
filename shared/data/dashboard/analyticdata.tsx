      ...
      series: [
        // Organic Search
        {
          ...
          data: [
            {
              x: "2023",
              y: [new Date(200, 2, 4).getTime(), new Date(280, 2, 4).getTime()]
            },
            {
              x: "2022",
              y: [new Date(180, 3, 21).getTime(), new Date(289, 2, 4).getTime()]
            }
          ]
        },
        // Direct
        {
          ...
          data: [
            {
              x: "2023",
              y: [new Date(280, 2, 4).getTime(), new Date(390, 2, 4).getTime()]
            },
            {
              x: "2022",
              y: [new Date(289, 3, 21).getTime(), new Date(420, 2, 4).getTime()]
            }
          ]
        },
        // Referral
        {
          ...
          data: [
            {
              x: "2023",
              y: [new Date(390, 2, 4).getTime(), new Date(560, 2, 4).getTime()]
            },
            {
              x: "2022",
              y: [new Date(420, 3, 21).getTime(), new Date(590, 2, 4).getTime()]
            }
          ]
        },
        // Social
        {
          ...
          data: [
            {
              x: "2023",
              y: [new Date(560, 2, 4).getTime(), new Date(900, 2, 4).getTime()]
            },
            {
              x: "2022",
              y: [new Date(590, 3, 21).getTime(), new Date(780, 2, 4).getTime()]
            }
          ]
        },
        // Email
        {
          ...
          data: [
            {
              x: "2023",
              y: [new Date(900, 2, 4).getTime(), new Date(960, 2, 4).getTime()]
            },
            {
              x: "2022",
              y: [new Date(780, 3, 21).getTime(), new Date(1020, 2, 4).getTime()]
            }
          ]
        },
        // Paid Search
        {
          ...
          data: [
            {
              x: "2023",
              y: [new Date(960, 2, 4).getTime(), new Date(1240, 2, 4).getTime()]
            },
            {
              x: "2022",
              y: [new Date(1020, 3, 21).getTime(), new Date(1104, 2, 4).getTime()]
            }
          ]
        }
      ],
