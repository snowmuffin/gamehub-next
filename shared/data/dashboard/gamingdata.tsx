...
//New Event
export class NewEvent extends Component<{}, spark3> {
...
//Completed Events
export class Completedissues extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//Pending Events
export class PendingEvents extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//Unsolved Events
export class UnsolvedEvents extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//Safe Zone
export class SafeZone extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//Danger Zone
export class DangerZone extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//Distance Covered
export class DistanceCovered extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//energy-block
export class Energyblock extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
        ...
        tooltip: {
          y: {
            formatter: function (val) {
              return val.toString(); // Ensure val is converted to a string
            }
          }
        },
        yaxis: {
          ...
          labels: {
            formatter: function (val, i) {
              ...
              return ""; // Return an empty string if formatter doesn't apply
            }
          }
        }
      }
...
//Air-Support
export class AirSupport extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class TimeSpent extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class Civilianpopulationsupport extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//civilian-population
export class Civilianpopulation extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//users-report
export class Usersreport extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//Performance
export class Player1 extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class Player2 extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class Player3 extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class Player4 extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class Player5 extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//Skills Achieved
interface skillachieved {
  id: number;
  name: string;
  now: number;
}
export const Skillachieved: skillachieved[] = [
