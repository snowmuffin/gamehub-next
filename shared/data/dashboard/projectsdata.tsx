...
export class ProjectOverview extends Component<{}, spark3> {
...
//projects-timeline
export class Projectstimeline extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
    this.state = {
      series: [
        {
          data: [
            {
              x: "Design Phase",
              y: [new Date("2024-01-20").getTime(), new Date("2024-02-08").getTime()],
            ...
            {
              x: "Testing",
              y: [new Date("2024-02-15").getTime(), new Date("2024-02-24").getTime()],
              fillColor: "rgba(235, 247, 72, 0.3)"
            },
            {
              x: "UAT",
              y: [new Date("2024-02-20").getTime(), new Date("2024-03-06").getTime()],
              fillColor: "rgba(0, 227, 210, 0.3)"
            },
            {
              x: "Deployment",
              y: [new Date("2024-03-08").getTime(), new Date("2024-03-19").getTime()],
              fillColor: "rgba(255, 74, 74, 0.3)"
            },
            {
              x: "Project closure",
              y: [new Date("2024-03-15").getTime(), new Date("2024-03-28").getTime()],
