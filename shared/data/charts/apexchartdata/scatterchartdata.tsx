...
export class Basicscatter extends Component<{}, spark3>
{
	...
	render() {
		return (
			<ReactApexChart options={this.state.options} series={this.state.series} type="scatter" width={"100%"} height={320} />
	...
	constructor(props: {} | Readonly<{}>) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["rgb(2,210,157)", "rgb(58,178,78)", "rgb(197,130,20)", "#e6533c", "#49b6f5"],
				grid: {
					borderColor: "#f2f5f7",
				},
				xaxis: {
