	...
	constructor(props: {} | Readonly<{}>) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["rgb(0,255,190)", "rgb(60, 186, 81)", "#f5b849", "#e6533c", "#49b6f5"],
				grid: {
					borderColor: "#f2f5f7",
				},
				title: {
	...
	constructor(props: {} | Readonly<{}>) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["rgb(0,255,190)", "rgb(60, 186, 81)", "#f5b849", "#e6533c", "#49b6f5", "#a65e76", "#5b67c7", "#a65e9a",
					"#26bf94", "rgb(60, 186, 81)"
				],
				grid: {
					borderColor: "#f2f5f7",
				},
	...
	constructor(props: {} | Readonly<{}>) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["rgb(0,255,190)", "rgb(60, 186, 81)", "#f5b849", "#49b6f5"],
				title: {
