...
export class Basicline extends Component<{}, spark3>{
	...
	render() {
		return (
			<ReactApexChart options={this.state.options} series={this.state.series} type="line" width={"100%"} height={300} />
	...
	constructor(props: {} | Readonly<{}>) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["rgb(0,255,190)", "rgb(72, 247, 104)"],
				dataLabels: {
					enabled: true,
				},
				stroke: {
...
export class Gradientline extends Component<{}, spark3>{
		...
		this.state = {
			...
			options: {
				...
				fill: {
					...
					gradient: {
						shade: "dark",
						gradientToColors: ["rgb(0,255,190)"],
						shadeIntensity: 1,
						type: "horizontal",
						opacityFrom: 1,
						opacityTo: 1,
	...
	render() {
		return (
			<div id="chart">
				<ReactApexChart options={this.state.options} series={this.state.series} type="line" width={"100%"} height={350} />
			</div>
	...
	constructor(props: {} | Readonly<{}>) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["rgb(0,255,190)", "#23b7e5", "#f5b849"],
	...
	constructor(props: {} | Readonly<{}>) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["rgb(0,255,190)", "rgb(72, 247, 104)", "#f5b849"],
				title: {
...
export class Syncing extends Component<{}, spark3>{
	...
	render() {
		return (
			<div id="wrapper">
				<div id="chart-line">
					<ReactApexChart options={this.state.options} series={this.state.series} type="line" width={"100%"} height={160} />
				</div>
				<div id="chart-line2">
					<ReactApexChart options={this.state.optionsLine2} series={this.state.seriesLine2} type="line" width={"100%"} height={160} />
				</div>
				<div id="chart-area">
					<ReactApexChart options={this.state.optionsArea} series={this.state.seriesArea} type="area" width={"100%"} height={160} />
				</div>
			</div>
