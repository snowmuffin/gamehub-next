...
export class Basicradialbar extends Component<{}, spark3>{
	...
	render() {
		return (
			<ReactApexChart options={this.state.options} series={this.state.series} type="radialBar" width={"100%"} height={300} />
	...
	constructor(props: {} | Readonly<{}>) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["rgb(78,255,210)", "rgb(72, 247, 104)", "rgb(212,141,23)", "rgb(255,74,74)"],
...
export class Circlechart extends Component<{}, spark3>{
	...
	render() {
		return (
			<ReactApexChart options={this.state.options} series={this.state.series} type="radialBar" width={"100%"} height={320} />
