        ...
        chart: {
          ...
          events: {
            mounted: function (chart: {
              getSeriesTotalXRange: (arg0: any, arg1: any) => any;
              w: { globals: { minX: any; maxX: any } };
            }) {
      ...
      <div id="wrapper">
        ...
        <div className="github-style d-flex align-items-center">
          ...
          <div className="userdetails lh-1">
            <Link href="#!" scroll={false} className="username fw-semibold fs-14">
              coder
            </Link>
  ...
  constructor(props: {} | Readonly<{}>) {
    ...
    this.state = {
      ...
      options: {
        ...
        colors: ["rgb(0,255,190)", "rgb(72, 247, 104)", "#e6eaeb"],
        grid: {
          borderColor: "#f2f5f7"
        },
        dataLabels: {
