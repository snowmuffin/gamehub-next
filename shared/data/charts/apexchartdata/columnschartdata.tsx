...
const colors = ["#00ffbe", "#3ab74e", "#ce8510", "#2c82bb", "#c44134", "#27ae61", "#5b67c7"];
    ...
    constructor(props: {} | Readonly<{}>) {
        ...
        this.state = {
            ...
            options: {
                ...
                colors: ["rgb(0,255,190)", "rgb(72, 247, 104)", "#f5b849", "#49b6f5", "#e6533c", "#26bf94", "#5b67c7", "#a65e76"],
                plotOptions: {
                    bar: {
                        columnWidth: "45%",
                        distributed: true,
